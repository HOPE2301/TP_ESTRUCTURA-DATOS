...
personaje3.datos()
linea_separadora()
print(f"{personaje1.nombre} tiene una suma total de poder de: {
      personaje1.calcular_poder()}")
print(f"{personaje2.nombre} tiene una suma total de poder de: {
      personaje2.calcular_poder()}")
print(f"{personaje3.nombre} tiene una suma total de poder de: {
      personaje3.calcular_poder()}")
...
if personaje_encontrado:
    print(f"Personaje encontrado con poder {
          poder_a_buscar}: {personaje_encontrado.nombre}")
else:
...
linea_separadora()
if nodo_encontrado:
    print(f"Nodo encontrado con nombre '{
          nombre_a_buscar}': {nodo_encontrado.datos.nombre}")
else:
...
for planeta in ruta:
    if camino == "":
        ...
        camino = camino + " -> " + str(planeta)
print(personaje1.get_nombre(),  "Viajará desde",
      str(planeta_1), " hasta", str(planeta_4))
print("Ruta optima: ", camino + " Distancia total: ", distancia_total)
personaje1.set_planeta(planeta_4)
print(f"{personaje1.nombre} ahora se encuentra en el planeta: {
      personaje1.get_planeta()}")
